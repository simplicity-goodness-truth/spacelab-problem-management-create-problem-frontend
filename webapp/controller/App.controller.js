sap.ui.define([
    ...
    return BaseController.extend("yslpmcrprb.controller.App", {
        ...
        */
        _getApplicationConfiguration: function (callback) {
            ...
            sharedLibrary.readEntityWithFilter("FrontendConfiguration", "Application eq 'yslpmcrprb'", sErroneousExecutionText, this, false, true, function (oData) {
